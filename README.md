...
Korisnik nakon definisanja interesa dobija listu artikala sa nazivom radnje u kojoj se nalazi artikal, cijenom te moguænosti kupovine. Prikazat æe se kolièina artikla, velièine (ako se radi o odjevnim predmetima)... 
Radnik (firma) æe imati svoj dio u sistemu kako bi mogli dodavati nove artikle te stavljati odgovarajuæe kupone (popuste) na veæ postojeæe. Takoðer, firme æe biti u moguænosti da provjere stanje artikala kako bi mogli ažurirati.
